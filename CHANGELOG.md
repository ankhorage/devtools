...
- bd35734: Update Devtools-owned dependencies: `@ankhorage/doctor`.

## 1.19.16

### Patch Changes

- 96a2184: Update Devtools-owned dependencies: `@ankhorage/doctor`.

## 1.19.15

### Patch Changes

- 85db4b0: Update Devtools-owned dependencies: `@ankhorage/contracts`.
...
- 67ddf36: Update Devtools-owned dependencies: `@ankhorage/doctor`.

## 1.19.12

### Patch Changes

- e972bc1: Update Devtools-owned dependencies: `@ankhorage/doctor`.
...
- 94782bd: Update Devtools-owned dependencies: `@ankhorage/doctor`.

## 1.19.8

### Patch Changes

- 46e7424: Update Devtools-owned dependencies: `@ankhorage/doctor`.
...
- ef39a36: Update Devtools-owned dependencies: `@ankhorage/doctor`.

## 1.19.5

### Patch Changes

- 3fd3bb7: Update Devtools-owned dependencies: `@ankhorage/doctor`.
...
- f4cd06b: Regenerate opted-in structural descriptor evidence after Changesets versioning and before the canonical release commit.

## 1.18.4

### Patch Changes

- 9d4c827: Regenerate opted-in structural descriptor evidence after Changesets versioning and before the canonical release commit.
...
- 4837266: Regenerate opted-in structural descriptor evidence after Changesets versioning and before the canonical release commit.
...
- 881d799: Generate release-owned documentation after versioning, keep documentation directories trackable, and clarify contextual repository skill loading.
...
- b57a587: Update Devtools-owned dependencies: `@ankhorage/doctor`.
...
- 0726279: Update Devtools-owned dependencies: `@ankhorage/ankh`.
...
- 557c9e4: Update Devtools-owned dependencies: `@ankhorage/ankh`.
- 4288aff: Update Devtools-owned dependencies: `@ankhorage/doctor`, `@types/node`.
